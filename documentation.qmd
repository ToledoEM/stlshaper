...
-   **Type:** Which noise field drives the displacement.
    ...
    -   *Perlin* — a coherent field, so nearby vertices move together. The surface reads as organic lumps and swells rather than grain.
...
-   **Scale:** Controls the frequency/size of noise features (0.005 - 0.5). In Perlin mode this sets how large the lumps are — lower values give broader, smoother swells.
